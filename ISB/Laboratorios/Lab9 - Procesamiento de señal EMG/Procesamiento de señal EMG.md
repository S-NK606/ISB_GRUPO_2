...
El estudio analizó señales electromiográficas (EMG) utilizando un filtro de wavelet y separación de fuentes ciegas (BSS) para eliminar artefactos y ruido. El objetivo era obtener señales limpias y representativas de la actividad muscular en diferentes condiciones de contracción.
•	Supresión de ruido: El filtro de wavelet eliminó efectivamente el ruido de alta frecuencia, preservando los componentes de baja frecuencia asociados con la contracción muscular. Las señales resultantes mostraron pulsos claros y definidos, con una línea base estable y una ausencia de artefactos.
•	Análisis de la actividad muscular: 
   o	Contracción leve: Se observaron pulsos bien definidos y un retorno claro a la línea base, indicando una activación muscular precisa y controlada.
   o	Contracción fuerte: Se observó una actividad continua de alta amplitud, característica de una contracción sostenida e intensa.
   o	Reposo: La señal presentó un bajo nivel de actividad y pulsos aislados, lo que indica un estado de relajación muscular.
•	Características de la señal EMG: 
   o	Frecuencia media (MFL): Aumentó con la intensidad de la contracción, reflejando el reclutamiento de fibras de contracción rápida.
   o	Myopulse Percentage Rate (MYOP): Aumentó con la intensidad de la contracción, indicando una mayor actividad muscular.
   o	Waveform Length (WAMP): Aumentó con la intensidad de la contracción, reflejando un incremento en la frecuencia de picos.
   o	Sample Entropy (SampEn): Aumentó con la intensidad de la contracción, indicando una mayor complejidad de la señal.
   o	Hjorth Parameter 2: Aumentó con la intensidad de la contracción, reflejando un mayor nivel de actividad dinámica.
   o	Curtosis: Aumentó con la intensidad de la contracción, indicando la presencia de picos de alta amplitud.
   o	Slope Sign Changes (SSC): Aumentó con la intensidad de la contracción, reflejando una mayor variabilidad en la activación.
El procesamiento de señales EMG utilizando el filtro de wavelet permitió obtener señales limpias y representativas de la actividad muscular. Las características extraídas de las señales (MFL, MYOP, WAMP, SampEn, Hjorth2, Curtosis, SSC) permitieron identificar patrones de activación muscular en diferentes condiciones de contracción y reposo. Estos resultados demuestran la utilidad del análisis de señales EMG para estudiar la función muscular y evaluar la fatiga.
